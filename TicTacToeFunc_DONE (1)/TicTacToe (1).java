...
public class TicTacToe
{
   ...
   public static final char[] BOARD_MARKS = { 'O', '-', 'X' };
   ...
   */
   ...
   /**
   returns a code indicating who has won
   @param board the board to check
   @return PLAYER_X, PLAYER_O, or NO_MOVE if no winner
   */
   ...
   */
   ...
   @param whoseTurn whose turn it is (X or O)
   @return the number of the desired move (0-8)
   */
   public static int getMove(int whoseTurn)
   {
   ...
   /**
   prints a message if the game has ended
   @param gameState a code indicating what end state is reached
   */
   public static void printWinner(int gameState)
   {
   ...
   public static void main(String[] args)
   {
      ...
      while(isPlaying)
      {
         ...
         else
         {
            ...
            int squareNum = getMove(whoseTurn);
            int row = squareNum / 3;
            int col = squareNum % 3;
